...
def display_5results(name):
    count=0
    links = get_business_news()
    ret1=links[name]["links"] #its a dictionary
    ret2=links[name]["texts"] #its a dictionary
...
res_dict=get_business_news()#['guardian']
res_str=articleFormatting.business_news(res_dict)
print(res_str)
