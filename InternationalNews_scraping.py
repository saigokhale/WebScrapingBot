...
def display_5results(name):
    count=0
    result=get_business_links()[name]
...
#input parameter= name of website in result dictionary.[bbc, guardian, reuters]

# =============================================================================
# display_5results("bbc")
# display_5results("guardian")
# display_5results("reuters")
# =============================================================================

print(get_business_links()['reuters'])

#functions to be called by discord:
# get_business_links() --> returns a dictionary of bbc, guardian, reuters; each having attributes as links and texts 
